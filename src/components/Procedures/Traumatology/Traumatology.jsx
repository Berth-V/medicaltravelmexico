...
function Traumatology() {
  ...
  return (
    <div className='trauma'>
      <motion.div className='trauma__section1'
        variants={introductionAnimation}
        initial='start'
        animate='end'      
      >
        <motion.div className='trauma__card'
          variants={introductionAnimation}
        >
          <motion.img className='trauma__img' src={hans}
            variants={introductionAnimation}
          />
            <div className='trauma__text'>
              <motion.h2 className='trauma__procedure'
                variants={introductionAnimation}
              >
                Traumatology
              </motion.h2>
              <motion.h2 className='trauma__doctor__name'
                variants={introductionAnimation}
              >
                Dr. Hans Ruiz
              </motion.h2>
              <motion.p className='trauma__description'
                variants={introductionAnimation}
              >
      ...
      <div className='trauma__section2'>
        <motion.div className='trauma__icon__box'
        ...
        >
          <div className='trauma__item'>
            ...
            <div  className='trauma__item__text'>
              <p className='trauma__icon__p'>
                They are performed on the spine, from anti-inflammatory 
                or platelet-rich plasma infiltrations, to performing 
                heat denervations to relieve spinal column pain.
                Herniated disc interventions and other surgical procedures 
                are also performed.
              </p>
            </div>
          </div>
          ...
          <div className='trauma__item'>
            ...
            <div  className='trauma__item__text'>
              <p className='trauma__icon__p'>
                Intervention of fractures of the whole body, arms, legs, knees, ankles, clavicle, femur, tibia, etc.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <div className='trauma__section3'>
        <div className='trauma__approaches'>
          ...
          <div className='trauma__approaches__item'>
            ...
            <p className='trauma__approaches__p'>
              Cartilage Repair, Meniscus Repair, Radius and Ulna surgery, Tendon Management, Carpal Tunnel, etc.
            </p>  
          </div>
          <div className='trauma__approaches__item'>
      ...
      <div className='trauma__section4'
        style={{background:`url(${regMedicine}) no-repeat bottom/var(--trauma4--backgronund-size) ` }}
      >
          <motion.h2 className='trauma__other__h2'
          ...
          <motion.p className='trauma__other__p'
            initial={{opacity:0, x:-50}}
            whileInView={{opacity:1, x:0}}
          ...
          >
            ...
            engineering, but also incorporates research into self-healing
            where the body uses its own systems, sometimes with the help
            of foreign biological material, to recreate cells and rebuild 
            tissues and organs.
          </motion.p>
      </div>
