...
function Otolaryngologist() {
  ...
  return (
    <div className='oto'>
      <motion.div className='oto__section1'
        variants={introductionAnimation}
        initial='start'
        animate='end'
      >
        <motion.div className='oto__card'
          variants={introductionAnimation}
        >
          <motion.img className='oto__img' src={sahid}
            variants={introductionAnimation}
          />
            <div className='oto__text'>
              <motion.h2 className='oto__procedure'
                variants={introductionAnimation}
              >
                Otolaryngologist
              </motion.h2>
              <motion.h2 className='oto__doctor__name'
                variants={introductionAnimation}
              >
                Dr. Sahid Singh
              </motion.h2>
              <motion.p className='oto__description'
                variants={introductionAnimation}
              >
                Your hearing and respiratory well-being is in good hands. 
                As an ENT doctor, my focus is providing effective solutions 
                for ear, nose and throat problems. Our treatments and procedures 
                are designed to improve your quality of life and overall well-being.<br/>
                At my practice, you will find a caring and caring team who are 
                committed to providing you with the highest level of medical care. <br/>
      ...
      <div className='oto__section2'>
        <motion.div className='oto__icon__box'
        ...
        >
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>
                Rhinoplasty is a surgery in which the shape of the nose is modified. 
                The reason for rhinoplasty may be to change the appearance of the nose,
                to improve breathing, or both.
              </p>
            </div>
          </div>
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>
                Septoplasty is a common surgery that is carried out to correct anatomical 
                problems of different natures in the nasal septum, which represents the 
                structure inside the nose that separates it into two nostrils or chambers.
              </p>
            </div>
          ...
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>
                It is a surgical intervention that consists of the extraction of the Bichat 
                balls  or bags. As it has been proven that they are only fat and not glands 
                that only give volume to the face, this operation can be done.
              </p>
            </div>
          </div>
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>
                Aesthetic blepharoplasty aims to remove fat and excess skin and muscle from the 
                upper and lower eyelids, with the aim of correcting the effects of facial aging.
              </p>
            </div>
          </div>
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>
              Otoplasty is surgery performed to reposition protruding or "protruding" ears to a 
              more normal position, closer to the head, or to reduce the size of large ears.
              </p>
            </div>
          </div>
          <div className='oto__item'>
            ...
            <div className='oto__item__text'>
              <p className='oto__icon__p'>              
                A tonsillectomy is surgery to remove the tonsils. Tonsils are lumps of tissue 
                located on either side at the back of the throat and help the immune system 
        ...
        <div className='oto__approaches'>
          ...
          <div className='oto__approaches__item'>
            ...
            <p className='oto__approaches__p'>
              Treatment from all Nasal Complications like Sinusitis, Alergic Rinitis,  
              Nasal Polypos, Smell Abnormalities, Nasal Alergys.
            </p>  
          </div>
          <div className='oto__approaches__item'>
          ...
          <div className='oto__approaches__item'>
            ...
            <p className='oto__approaches__p'>
              Treatmen of Tonsillitis, Pharyngitis, Laryngitis, Head and Neck Cancer,
              Dysphagia, Oral Candidiasis.
            </p>  
          </div>
          <div className='oto__approaches__item'>
          ...
          <h2 className='oto__approaches__tittle'>Ear Medicine</h2>
            <p className='oto__approaches__p'>
              Treatment of Otitis, Eustachian tube dysfunction, Serous otitis media,
              Earwax and Earwax Wash
            </p>  
          </div>
          <div className='oto__approaches__item'>
